...
Start = function()
	...
	BtnShimmer:GetComponent(typeof(CS.ExButton)).onClick:AddListener(ManualActiveSkill)
	if not gameStartAnimFlag then
		JoyStick:SetActive(false)
		BtnShimmer:SetActive(false)
	end
	CS.CommonInputManager.Instance:AddKeyListener(CS.UnityEngine.KeyCode.J, ManualActiveSkill)
end
...
OnDestroy =function()
	...
	CS.CommonInputManager.Instance:RemoveKeyListener(CS.UnityEngine.KeyCode.J, ManualActiveSkill)
